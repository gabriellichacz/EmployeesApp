...
class Employee extends Model
{
     ...
     * @return \Illuminate\Contracts\Pagination\LengthAwarePaginator
     */
    public static function getEmployeeTableFiltered(string $gender, string $department, int $min, int $max, string $status) : \Illuminate\Contracts\Pagination\LengthAwarePaginator
    {
